      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs text-zinc-600">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy-policy" className="hover:text-[#B26CE8] transition-colors" data-testid="footer-privacy-link">
              Privacy Policy
            </Link>
            <Link href="/terms-and-conditions" className="hover:text-[#B26CE8] transition-colors" data-testid="footer-terms-link">
              Terms &amp; Conditions
            </Link>
